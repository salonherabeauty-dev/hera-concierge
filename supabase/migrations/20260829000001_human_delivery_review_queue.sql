...
drop function if exists public.ai_cc_list_human_delivery_queue(uuid, uuid, integer);
...
as $$
  select
    ...
    policy.risk,
    source.text_body as client_message,
...
drop function if exists public.ai_cc_approve_human_delivery_candidate(
